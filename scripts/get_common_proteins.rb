# USAGE:
# ruby get_common_proteins.rb ../results/experiment_1_aspirin_only_peptides.xlsx ../results/experiment_2_score_35_positive_reps.xlsx ../data/Experiment_3.xlsx  ../results/overlapped_proteins.xlsx
...
results_wb.add_worksheet(:name => "1-2-3 overlaps") do |sheet|
	...
	exp3_list.each do |protein, hit|
		if exp2_list.has_key?(protein) && exp1_list.has_key?(protein)
